<?php
require_once 'includes/config.inc.php'; // Include the database connection file

// Check if student roll number is set in the session
...
$query = "SELECT am.*
          ...
          WHERE am.receiver_id = '$Student_id'";
